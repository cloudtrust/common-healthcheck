...
//
//	mockgen --build_flags=--mod=mod -destination=./mock/healthcheck.go -package=mock -mock_names=HealthChecker=HealthChecker github.com/cloudtrust/common-healthcheck HealthChecker
//
...
func (mr *HealthCheckerMockRecorder) HealthCheck(arg0, arg1 any) *gomock.Call {
